// Lucide SVG icon paths (duotone offset style).
// Usage: import { icon, iconSvg } from '../lib/icons.js';
// In markup: {@html iconSvg('dashboard', 18)}
...
const ICON_PATHS = {
  ...
  bot: '<path d="M12 8V4H8"/><rect width="16" height="12" x="4" y="8" rx="2"/><path d="M2 14h2m16 0h2m-7-1v2m-6-2v2"/>',
